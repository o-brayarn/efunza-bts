    ...
    <div className="container-fluid bg-primary text-white ">
      <footer className="pt-5">
        <div className="row">
          ...
          <div className="col-6 col-sm-3 col-md-2 mb-3">
            ...
            <ul className="nav flex-column" style={{ fontSize: "0.75rem" }}>
              <li className="nav-item mb-2">
                ...
                <a
                  href="mailto:hello@efunzabts.com"
                  className="nav-link p-0 text-white"
                >
                  hello@efunzabts.com
                </a>
                <a
                  href="mailto:support@efunzabts.com"
                  className="nav-link p-0 text-white"
                >
                  support@efunzabts.com
                </a>
              </li>
              <li className="nav-item mb-2">
                <label htmlFor="">Call or Whatsapp: </label>
                <a
                  href="tel:+(254)701234567"
                  className="nav-link p-0 text-white"
                >
                  (254)701234567
                </a>
          ...
          <div className="col-12 col-sm-6 col-md-4 offset-md-0 mb-3">
            <form>
              ...
              <div className="d-flex flex-column flex-sm-row w-75 gap-2 form-floating ">
                <input
                  type="email"
                  name=""
                  id="floatingInput"
                ...
                />
                <label htmlFor="newsletter1" className="text-secondary">
                  Email address
                </label>
